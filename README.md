...
#### 📊 공연시장 분석 시스템
- **실시간 시장 분석**: 카테고리별, 지역별, 가격대별 공연 분포 분석
- **시장 공백 분석**: 부족한 공연 영역 식별 및 기회 제공
- **트렌드 예측**: 향후 공연시장 동향 예측
- **대시보드 시각화**: Plotly 기반 인터랙티브 차트

#### 🎯 개인화 추천 시스템
- **선호도 기반 추천**: 사용자 취향에 맞는 공연 추천
- **인기도 기반 추천**: 인기 있는 공연 추천
- **다양성 기반 추천**: 다양한 장르의 공연 추천
- **하이브리드 추천**: 여러 방법을 조합한 최적 추천

#### 🔗 KOPIS API 연동
- **실시간 데이터 동기화**: KOPIS 공연 데이터 자동 수집
- **데이터 분석**: KOPIS 데이터 기반 시장 분석
- **성과 예측**: 공연 성공 가능성 예측 모델
